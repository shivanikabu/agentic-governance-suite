"""
Prompt Assessment Agent Application
===================================
A Streamlit application for AI governance and prompt security assessment.
Evaluates user inputs and AI responses for prompt injection attacks, bias, and
hallucinations using NLP-based classification techniques to ensure prompt integrity
and prevent adversarial manipulations.
"""
...
from Governance.AnalyzePromptsAgent import start_agent_pipeline
...
st.markdown(
    "<h1 style='font-size: 32px; text-align: center;'>Prompt Assessment Agent</h1>",
...
**Prompt Assessment Agent** – The Prompt Assessment Agent evaluates user inputs and AI 
responses for prompt injection attacks, bias, and hallucinations using NLP-based 
classification techniques. It ensures prompt integrity, prevents adversarial manipulations, 
...
if st.button("Run Assessment"):
    ...
    # Execute the Prompt Assessment agent pipeline asynchronously
    # Analyzes prompts for injection attacks, bias, and hallucinations
    agents_response = asyncio.run(start_agent_pipeline(f'data/{option}', description))
    
    # Display prompt assessment results
